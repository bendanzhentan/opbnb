...
contract L2DelegateBridge is OwnableUpgradeable, FeeVault, Semver {
    ...
    function initiateWithdrawal(
        ...
        require(msg.value == delegation_fee + _amount, "msg.value does not equal delegation fee + amount");
