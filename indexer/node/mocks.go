...
func (m *MockEthClient) GetTransactionReceipt(txHash common.Hash) (*types.Receipt, error) {
	return nil, nil
}
...
func (m *MockEthClient) GetProof(address common.Address, storageKeys []string, blockNumber *big.Int) (*eth.AccountResult, error) {
	return nil, nil
}
...
func (m *MockEthClient) EstimateGas(ctx context.Context, call ethereum.CallMsg) (gas uint64, err error) {
	return 0, nil
}
